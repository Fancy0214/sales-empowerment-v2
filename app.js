...
const scripts = [
    // === 冷触达 ===
    { id: 1, category: "cold_outreach", title: "打给机构老板-30秒抓住注意力", scene: "首次联系机构负责人/老板", content: "张总您好，我是XX的Lily，专注英国留学27年了。今天不打长电话，就想问一句——贵司英国方向的佣金，现在多久结一次？我们这边月结，不少合作方之前都是季度甚至半年才拿到钱，换过来之后都说现金流松了不少。您要是有兴趣，我发个院校清单和佣金表给您看看？就两分钟的事。", rating: 5, type: "电话开发" },
    { id: 2, category: "cold_outreach", title: "加外联老师微信-给个实在理由", scene: "展会/活动后加外联老师", content: "李老师好，我是今天在展会上跟您聊了几句的Lily。您提到英国这边想找新渠道，我回去整理了一下我们目前能做的院校——KCL、曼大、华威、格拉斯哥这些都有代理，佣金政策也更新了。方便发您看看不？不合适也没关系，先留着备用。", rating: 5, type: "微信沟通" },
    { id: 3, category: "cold_outreach", title: "冷邮件-三段话讲清楚价值", scene: "邮件首次触达机构决策者", content: "王总好，\n\n简单说三点：\n1. 我们专注英国27年，前100有代理的院校基本能做（KCL、曼大、华威、格拉斯哥、利兹、南安普顿等），爱尔兰TCD也有佣金\n2. 佣金月结，不用等季度，对您现金流友好\n3. 人工+AI双线服务，周末也能找到人\n\n先从1-2个case试起，用结果说话。方便的话约个15分钟电话？\n\nLily", rating: 4, type: "邮件触达" },
    { id: 4, category: "cold_outreach", title: "找到后期负责人-从痛点切入", scene: "联系机构后期/文案主管", content: "赵老师您好，我是XX的Lily。想跟您了解一下，贵司英国方向后期的case，目前对接顺畅吗？我听到不少后期老师抱怨合作方回复慢、周末找不到人，我们的服务团队人工+AI双线，基本做到有问题当天响应。要不我先发个服务流程和响应时效标准给您参考？", rating: 4, type: "电话开发" },
    { id: 5, category: "cold_outreach", title: "联系销售老师-帮他多签约", scene: "联系机构一线销售顾问", content: "陈老师好，我是XX的Lily。知道你们一线老师最在意什么——院校要多、佣金要稳、出了问题有人兜。英国方向我们前100有代理的院校基本覆盖了，佣金月结不拖欠，周末节假日也能找到人。您要是英国方向有学生想多签约几个院校，我们可以先配合着来。", rating: 4, type: "微信沟通" },

    // === 跟进升温 ===
    { id: 6, category: "warm_follow", title: "二次跟进-带着新资源回来", scene: "首次沟通后3-5天跟进", content: "张总，上次跟您聊完我特意查了一下，您提到的XX院校我们刚好新拿到了代理权，佣金政策也出来了——比您目前的合作方大概高出X个点，而且是月结。另外我们最近也签了几个新院校，我把清单一起发您？您看这周哪天方便电话聊聊？", rating: 5, type: "二次触达" },
    { id: 7, category: "warm_follow", title: "对方说'考虑考虑'-锁定时间", scene: "客户态度模糊", content: "完全理解，选合作方确实得慎重。这样，我不催您做决定，但能不能定个时间我再来找您？比如下周三？我提前把最新的院校清单、佣金政策和结算方式整理好发您，您看了心里有个数，咱们再聊也更有针对性。", rating: 5, type: "跟进升温" },
    { id: 8, category: "warm_follow", title: "对方冷淡-用案例撬开话匣子", scene: "客户兴趣不高", content: "张总，理解您现在合作伙伴可能够用。不过我想问一句——您现在英国方向，佣金多久结一次？我们最近帮一家跟贵司体量差不多的机构切过来，光佣金月结这一项，他们现金流就松了很多。另外院校匹配也更精准，签约转化率提了15%。要不我发个案例给您看看？", rating: 4, type: "跟进升温" },
    { id: 9, category: "warm_follow", title: "跟后期老师-从服务体验入手", scene: "上次聊过后期对接体验", content: "赵老师，上次您提到后期对接有时候响应慢，我回去特意了解了一下我们的服务标准——工作日2小时内响应，周末和节假日也能找到人，紧急情况直接电话。另外我们的AI系统可以实时查看申请进度，不用反复催问。您要不要先推一个case试试手感？", rating: 4, type: "跟进升温" },

    // === 异议拆解（LSCPA实战版） ===
    { id: 10, category: "objection", title: "「我们已经有合作方了」-LSCPA", scene: "最常见的异议", content: "【L-倾听】明白，您这边已经有稳定的合作方了，那肯定是合作得顺畅才会一直合作，对吧？\n\n【S-共情】特别理解，找一个靠谱的合作方不容易，稳定合作省去很多沟通成本，换做是我也会优先维护现有合作关系。\n\n【C-澄清】其实我也不是来打扰您的，就是做个行业交流——想了解一下，您和现有合作方合作，主要看中的是哪块优势？比如是佣金结算快、服务响应好，还是院校覆盖广？\n\n【P-方案】那还挺契合的，我们这边主做的是英国前100有代理的院校资源，佣金月结不拖欠，部分可垫付——刚好能作为现有合作的补充。很多有稳定合作方的伙伴都会和我们搭着做，不要求您替换，只是多一个优质备选。\n\n【A-行动】我把核心优势、服务流程和院校清单发您一份，您空的时候看看，我下周三下午再跟您轻聊5分钟，同步下行业最新合作资源，您看可以吗？", rating: 5, type: "LSCPA异议处理" },
    { id: 11, category: "objection", title: "「你们佣金没有XX高」-LSCPA", scene: "老板/销售对佣金敏感", content: "【L-倾听】明白，佣金确实是合作的核心考量，您关心这个太正常了。\n\n【S-共情】特别理解，做这一行佣金高低直接影响收益，谁都想拿到更好的条件，换我我也得比比看。\n\n【C-澄清】想跟您确认一下，您说的佣金顾虑，主要是觉得比例不够高，还是结算周期太长、资金占用太多？这两块解决思路其实不一样。\n\n【P-方案】是这样，我们这边有几个差异化：第一，佣金月结，不少同行是季度甚至半年才打款，等于您白白垫了几个月资金；第二，部分情况可以垫付，行业里不多见；第三，签约效率高，同样时间能多出几单，您算算总账其实更划算。\n\n【A-行动】我发一份佣金政策对比表给您，您和现在的条件对比看看。下周二我再跟您简单聊聊，您看行吗？", rating: 5, type: "LSCPA异议处理" },
    { id: 12, category: "objection", title: "「不确定你们服务行不行」-LSCPA", scene: "后期老师/销售质疑服务", content: "【L-倾听】明白，服务质量确实是合作能不能长久的关键，您有这个顾虑说明您对学生负责。\n\n【S-共情】特别理解，之前肯定也遇到过合作方前期说得好、签约后找不到人的情况，这种体验确实很糟糕。\n\n【C-澄清】想了解一下，您之前遇到的服务问题，主要是响应慢、周末找不到人，还是申请过程中沟通不透明？这样我知道具体哪块让您不放心。\n\n【P-方案】这几个问题我们正好都解决了：工作日2小时内响应，周末和节假日也能找到人；AI系统实时同步申请进度，不用反复催问；紧急情况24小时电话直达。27年专注英国，各种case都处理过。\n\n【A-行动】您先推1-2个学生试试，感受一下响应速度和专业度，体验不好随时停，没有任何风险。您看这周能安排吗？", rating: 5, type: "LSCPA异议处理" },
    { id: 13, category: "objection", title: "「你们能做哪些院校？覆盖够不够？」-LSCPA", scene: "外联/销售关心院校资源", content: "【L-倾听】明白，院校资源覆盖确实是合作的基础，您关心这个很正常。\n\n【S-共情】特别理解，签约的时候学生想申的院校做不了，等于白白流失客户，谁遇到都头疼。\n\n【C-澄清】想跟您确认一下，您目前最需要的是哪些院校的补充？是有几个特定学校想做但现有合作方覆盖不了，还是整体英国方向的院校池想扩大？\n\n【P-方案】我们英国前100有开放代理的院校基本能做——KCL、曼大、布里斯托、华威、格拉斯哥、利兹、南安普顿、谢菲、杜伦、诺丁汉这些是主力，爱尔兰TCD也有佣金。如果有特定院校想做，告诉我，我去确认能不能加进来。\n\n【A-行动】我发一份最新院校清单和佣金表给您，您对照看看有没有缺口。有特别想加的院校也告诉我，我查完给您反馈，您看可以吗？", rating: 5, type: "LSCPA异议处理" },
    { id: 14, category: "objection", title: "「今年换不了了/明年再说」-LSCPA", scene: "时机异议", content: "【L-倾听】明白，您这边目前确实没有紧迫的合作需求，完全理解。\n\n【S-共情】特别理解，合作这种事确实要看时机，不是随便就能动的。\n\n【C-澄清】想跟您确认一下，是今年确实没有计划了，还是说目前还在观望阶段，想多了解几个选项备着？\n\n【P-方案】即使本年度暂无合作计划，我们可以先建立联系。很多合作方一开始也是先了解着，等有需求的时候发现我们正好能满足，直接就启动了，不用再从头筛选。您不需要做任何承诺。\n\n【A-行动】我把院校清单和佣金政策发您存着，另外想跟您确认——如果下一年度贵司有补充或更换合作方的需求，咱们是否有优先洽谈的机会？这样到时候不用再重新找，您看可以吗？", rating: 4, type: "LSCPA异议处理" },
    { id: 15, category: "objection", title: "「佣金安全吗？会不会跑路？」-LSCPA", scene: "老板/个人代理最关心安全", content: "【L-倾听】明白，佣金安全确实是合作的前提，您有这个顾虑太正常了。\n\n【S-共情】特别理解，这个行业确实鱼龙混杂，谁都不想遇到佣金拿不到的情况，谨慎是对的。\n\n【C-澄清】想跟您确认一下，您担心的主要是佣金拖欠，还是担心合作方跑路？这两个我们都能打消您的顾虑。\n\n【P-方案】27年专注英国，佣金安全是我们的底线。月结不拖欠，每个case的佣金明细清清楚楚，没有灰色地带。而且我们能从小case开始，跑一单您就知道了——很多现在的大合作方，一开始也是这么试过来的。\n\n【A-行动】我发一份合作流程和佣金结算说明给您，您看看我们怎么保障佣金安全的。有问题随时问我，您看可以吗？", rating: 4, type: "LSCPA异议处理" },

    // === 临门促单 ===
    { id: 16, category: "closing", title: "试合作-降低决策门槛", scene: "意向有了但还在犹豫", content: "张总，咱别想太复杂。您先推1-2个英国的学生过来，我们全程跟进——佣金月结、响应2小时内、周末也有人。不需要签大协议，一个合作确认函就行。跑通一个case，您心里就有数了。您看这周能安排吗？", rating: 5, type: "临门促单" },
    { id: 17, category: "closing", title: "锚定签约-卡住时间窗口", scene: "对方说好但一直不推进", content: "张总，既然方向都聊对了，我建议这周就把合作确认函签了，下周就能开始对接学生。英国申请窗口就那几个月，早启动一天就多一分优势。而且我们佣金月结，您不用等，签约就有进账。您看周四还是周五方便？", rating: 5, type: "临门促单" },
    { id: 18, category: "closing", title: "直面最后顾虑-把话说开", scene: "签约前最后一哆嗦", content: "张总，我能感觉您还有点犹豫，您直说——最担心什么？佣金安全？结算速度？服务响应？还是院校覆盖不够？咱们敞开聊，能解决的我当场给您方案，不能解决的我也实话实说。合作最怕有话憋着，后面反而容易出问题。", rating: 4, type: "临门促单" },

    // === 长期培育 ===
    { id: 19, category: "nurture", title: "首单交付后-趁热扩大", scene: "第一个case出结果后", content: "张总，XX同学的offer下来了，从提交到出结果X天，比市场平均快吧？趁这个势头，咱们聊聊扩大合作——最近又签了几个新院校，佣金政策也有调整，我整理一下发您？另外签约量上来之后，佣金档位可以再谈谈。", rating: 5, type: "长期培育" },
    { id: 20, category: "nurture", title: "节日问候-带点实在价值", scene: "节日/假期前", content: "张总，中秋快乐！知道您忙就不多聊了，顺便提一句：我们刚拿到XX大学2026年最新佣金政策，比去年涨了2个点，而且是月结不变。节后我发您详细看看？", rating: 4, type: "长期培育" },
    { id: 21, category: "nurture", title: "沉睡客户唤醒-给个新理由", scene: "很久没合作的机构", content: "张总好久不见！最近英国那边有几个新变化——曼大和利兹2026年新增了几个专业的代理通道，佣金也调了，而且我们现在是月结+可垫付，之前没有的。您那边英国方向学生量怎么样？如果有需求，这次的政策窗口值得抓。", rating: 4, type: "长期培育" },
    { id: 22, category: "nurture", title: "续约升级-用数据说话", scene: "试合作期结束", content: "张总，咱们合作一阵了，配合得应该还不错吧？我想跟您聊个事——签约量到一定规模，佣金档位可以再优一档，另外我们会配专属对接经理，响应更快，周末也优先处理您的case。您看有没有兴趣升级一下合作？", rating: 4, type: "长期培育" },
    { id: 23, category: "nurture", title: "给后期老师-持续服务保障", scene: "合作中的后期老师维护", content: "赵老师，最近对接还顺畅吧？有个事跟您同步一下——我们AI系统升级了，现在申请进度可以实时查看，不用再等着邮件通知了。另外我们加了紧急响应通道，遇到突发情况直接打电话就行，24小时有人接。您用着有什么不方便的地方随时跟我说。", rating: 4, type: "长期培育" }
];
...
function generateScript() {
    ...
    if (reachStage === '首次触达') {
        if (isBoss) {
            opening = `${identityLabel}您好，我是${myRole}，专注英国留学27年了。今天不打长电话，就想问一句——贵司英国方向的佣金，现在多久结一次？我们这边月结，不少合作方之前季度甚至半年才拿到钱，换过来之后都说现金流松了不少。`;
        } else if (isSales) {
            opening = `${identityLabel}好，我是${myRole}。知道你们一线最在意什么——院校要多、佣金要稳、出了问题有人兜。英国方向我们前100有代理的院校基本覆盖了，佣金月结不拖欠，周末节假日也能找到人。`;
        } else if (isWailian) {
            opening = `${identityLabel}好，我是${myRole}，专注英国27年。今天想跟您聊聊英国方向的院校资源和合作模式——KCL、曼大、华威、格拉斯哥这些我们都有代理，佣金政策也刚更新了。`;
        } else if (isHouqi) {
            opening = `${identityLabel}您好，我是${myRole}。想了解一下贵司英国方向后期的case对接还顺畅吗？不少后期老师反馈合作方回复慢、周末找不到人，我们人工+AI双线，基本当天响应。`;
        } else {
            opening = `${identityLabel}您好，我是${myRole}，专注英国留学27年了。了解到${clientBackground ? '贵司在' + bg.substring(0,30) + '方面有积累' : '您在留学行业'}，想看看我们能不能在英国方向帮您多一个靠谱的选择？`;
        }
        ...
        opening = `${identityLabel}您好，我是${myRole}，专注英国留学27年，想跟您探讨一下合作机会。`;
    }
    ...
    if (objectionType === 'has_partner') {
        // 最常见异议："我们已经有合作方了"
        lscpa = `${lLabel}："明白，您这边已经有稳定的合作方了，那肯定是合作得很顺畅才会一直合作，对吧？"\n\n${sLabel}："特别理解，找一个靠谱的合作方不容易，稳定合作也能省去很多沟通成本，换做是我也会优先维护现有合作关系。"\n\n${cLabel}："其实我也不是来打扰您的，就是做个行业交流——想了解一下，您和现有合作方合作，主要看中的是哪块优势？比如是佣金结算快、服务响应好，还是院校覆盖广？"\n\n${pLabel}："那还挺契合的，我们这边主做的是英国前100有代理的院校资源（KCL、曼大、华威、格拉斯哥等），佣金月结不拖欠，部分可垫付——刚好能作为现有合作的补充。很多有稳定合作方的伙伴都会和我们搭着做，不要求您替换现有合作，只是多一个优质备选。"\n\n${aLabel}："我把我们的核心优势、服务流程和院校清单发您一份，您空的时候看看，我下周三下午再跟您轻聊5分钟，同步下行业最新的合作资源，您看可以吗？"`;
    } else if (objectionType === 'commission') {
        // 佣金异议："你们佣金不够高/结算不够快"
        lscpa = `${lLabel}："明白，佣金确实是合作的核心考量，您关心这个太正常了。"\n\n${sLabel}："特别理解，做这一行佣金高低直接影响收益，谁都想拿到更好的条件。换我我也得比比看。"\n\n${cLabel}："想跟您确认一下，您说的佣金方面的顾虑，主要是觉得比例不够高，还是结算周期太长、资金占用太多？因为这两块其实解决思路不一样。"\n\n${pLabel}："是这样，我们这边有几个差异化：第一，佣金月结，不少同行是季度甚至半年才打款，等于您白白垫了几个月资金；第二，部分情况可以垫付，这在行业里不多见；第三，签约效率高，同样时间能多出几单，您算算总账其实更划算。"\n\n${aLabel}："我发一份我们的佣金政策对比表给您，您和现在的条件对比看看。下周二我再跟您简单聊聊，您看行吗？"`;
    } else if (objectionType === 'service') {
        // 服务异议："不确定你们服务行不行/响应快不快"
        lscpa = `${lLabel}："明白，服务质量确实是合作能不能长久的关键，您有这个顾虑说明您对学生负责。"\n\n${sLabel}："特别理解，之前肯定也遇到过合作方前期说得好、签约后找不到人的情况，这种体验确实很糟糕。"\n\n${cLabel}："想了解一下，您之前遇到的服务问题，主要是响应慢、周末找不到人，还是申请过程中沟通不透明？这样我知道具体是哪块让您不放心。"\n\n${pLabel}："这几个问题我们正好都解决了：工作日2小时内响应，周末和节假日也能找到人；AI系统实时同步申请进度，不用反复催问；紧急情况24小时电话直达。而且27年专注英国，各种case都处理过，比泛做的机构更专业。"\n\n${aLabel}："您先推1-2个学生试试，感受一下我们的响应速度和专业度，体验不好随时停，没有任何风险。您看这周能安排吗？"`;
    } else if (objectionType === 'coverage') {
        // 院校覆盖异议："你们能做哪些院校？够不够？"
        lscpa = `${lLabel}："明白，院校资源覆盖确实是合作的基础，您关心这个很正常。"\n\n${sLabel}："特别理解，签约的时候学生想申的院校做不了，等于白白流失客户，谁遇到都头疼。"\n\n${cLabel}："想跟您确认一下，您目前最需要的是哪些院校或哪些方向的补充？是有几个特定的学校想做但现有合作方覆盖不了，还是整体英国方向的院校池想扩大？"\n\n${pLabel}："我们英国前100有开放代理的院校基本能做——KCL、曼大、布里斯托、华威、格拉斯哥、利兹、南安普顿、谢菲、杜伦、诺丁汉这些都是主力，爱尔兰TCD也有佣金。如果有些特定院校您想做但目前没有，告诉我，我去确认能不能加进来，院校池一直在扩展。"\n\n${aLabel}："我发一份最新的院校清单和佣金表给您，您对照着看看有没有缺口的。有特别想加的院校也告诉我，我查完给您反馈，您看可以吗？"`;
    } else if (objectionType === 'timing') {
        // 时机异议："不急/明年再说/今年肯定换不了"
        lscpa = `${lLabel}："明白，您这边目前确实没有紧迫的合作需求，完全理解。"\n\n${sLabel}："特别理解，合作这种事确实要看时机，不是随便就能动的。"\n\n${cLabel}："想跟您确认一下，是今年确实没有计划了，还是说目前还在观望阶段，想多了解几个选项备着？"\n\n${pLabel}："这样，即使本年度暂无合作计划，我们可以先建立联系。很多合作方一开始也是先了解着，等有需求的时候发现我们正好能满足，直接就启动了，不用再从头筛选。您不需要做任何承诺，我先发资料给您留着就好。"\n\n${aLabel}："我把院校清单和佣金政策发您存着，另外想跟您确认——如果下一年度贵司有补充或更换合作方的需求，咱们是否有优先洽谈的机会？这样到时候不用再重新找，您看可以吗？"`;
    } else {
        // 通用异议处理模板
        lscpa = `${lLabel}："明白，您有顾虑是正常的，能说出来反而好沟通。"\n\n${sLabel}："特别理解，选合作方确实要慎重，毕竟涉及到学生和佣金的事。"\n\n${cLabel}："方便说说您最担心的是哪方面吗？是佣金安全、服务响应，还是院校覆盖？这样我可以有针对性地给您方案。"\n\n${pLabel}："不管您担心的是哪块，我们的核心承诺是：佣金月结不拖欠、服务2小时响应周末也有人、英国前100有代理的基本能做。如果还有具体顾虑，我可以逐个给您解答。"\n\n${aLabel}："我先把我们的核心优势资料发您看看，有问题随时问我，咱们不着急，您先了解着，您看可以吗？"`;
    }
